...
VALUES
('emp-01', 'EMP-1001', N'Sarah Jenkins', 'sarah.jenkins@nexus.telecom', '+1 (555) 234-8901', '$2a$11$eXampleHashedPasswordAdminSarah1234567890', 'Manager', N'Administration', NULL, 'Active', '2022-03-15', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150', N'742 Evergreen Terrace, NY', N'Female', '1988-04-12', N'Senior Operations Manager leading overall telecommunication infrastructure and store network.'),
('emp-02', 'EMP-1042', N'David Chen', 'david.chen@nexus.telecom', '+1 (555) 456-1123', '$2a$11$eXampleHashedPasswordRetailDavid1234567890', 'Retail Staff', N'Retail Outlets', 'SH-01', 'Active', '2023-06-10', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', N'120 Broadway, Manhattan, NY', N'Male', '1992-09-25', N'Flagship Store lead customer representative specialized in corporate bulk schemes.'),
('emp-03', 'EMP-1077', N'Marcus Ramirez', 'marcus.ramirez@nexus.telecom', '+1 (555) 789-3344', '$2a$11$eXampleHashedPasswordTechMarcus1234567890', 'Field Engineer', N'Technical Operations', 'SH-01', 'Active', '2021-11-04', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', N'88 Bedford Ave, Brooklyn, NY', N'Male', '1990-12-05', N'Lead technical supervisor handling fiber splicing, line attenuation testing, and DP box routing.'),
('emp-04', 'EMP-1090', N'Elena Rostova', 'elena.rostova@nexus.telecom', '+1 (555) 901-5567', '$2a$11$eXampleHashedPasswordAccountsElena123456789', 'Senior Accountant', N'Finance & Accounts', NULL, 'Active', '2020-08-20', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', N'45 Wall Street, Suite 900, NY', N'Female', '1985-02-18', N'Head of Billing and Financial Accounts handling ledger audits, invoices, and service tax returns.'),
('emp-05', 'EMP-1105', N'Aiden Brooks', 'aiden.brooks@nexus.telecom', '+1 (555) 345-6789', '$2a$11$eXampleHashedPasswordRetailAiden1234567890', 'Retail Staff', N'Retail Outlets', 'SH-02', 'Active', '2024-01-15', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150', N'220 W 98th St, NY', N'Male', '1995-07-14', N'Customer support specialist and subscriber onboarding executive.');
